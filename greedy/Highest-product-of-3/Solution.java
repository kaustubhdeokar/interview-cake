...
public class Solution {
    ...
    public static int highestProductOf3(int[] intArray) {
        ...
        int highestOf2 = Integer.MIN_VALUE;
        int lowestOf2 = Integer.MAX_VALUE;
        int highestOf3 = Integer.MIN_VALUE;
        
        for(int i=1;i<intArray.length;i++){
            int curr = intArray[i];
            if(i>1){
                if(curr*highestOf2 > highestOf3){
                    highestOf3 = curr*highestOf2;
                }
                if(curr*lowestOf2 > highestOf3){
                    highestOf3 = curr*lowestOf2;
                }
            }
            if(curr * lowest < lowestOf2){
                lowestOf2 = curr*lowest;
            }
            if(curr * highest < lowestOf2){
                lowestOf2 = curr*highest;
            }
            
            if(curr * highest > highestOf2){
                highestOf2 = curr* highest;
            }
            if(curr * lowest > highestOf2){
                highestOf2 = curr* lowest;
            }
            
            lowest = Integer.min(lowest,curr);
            highest = Integer.max(highest,curr);
        }
