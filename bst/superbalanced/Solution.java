...
public class Solution {
    ...
    public static boolean isBalanced(BinaryTreeNode treeRoot) {
        ...
        Optional<Integer> first = leafHeights.stream().findFirst();
        leafHeights.remove(first.get());
        Optional<Integer> second = leafHeights.stream().findFirst();
        if(Math.abs(first.get()-second.get())>1){
            return false;
        }
    ...
    public static void iterateInOrder(BinaryTreeNode root, Set<Integer> leafHeights,int level){
